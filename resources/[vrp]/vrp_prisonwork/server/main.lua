...
AddEventHandler('vRP:Pay', function()
	...
	TriggerClientEvent("pNotify:SendNotification", player,{text = "Du modtog: <b style='color: #4E9350'>" ..Config.Payment.. " $.</b> ", type = "success", queue = "global", timeout = 8000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}, sounds = { sources = {"cash.ogg"}, volume = 0.6, conditions = {"docVisible"}}}) 
