	...
	vRP.getUserIdentity({user_id, function(identity)
		...
		if license:find("P "..regi) then
			if cop or ems or cop2 then
				...
				TriggerClientEvent("pNotify:SendNotification", player, {text = "<b style='color:#ED2939'>Fartfælde</b><br /><br />Du kørte " .. kmhspeed .. "KM/T hvor du må køre "..tostring(maxspeed).." KM/T <br /><b style='color:#26ff26'>Bøde</b>: " .. tax ..",- $",type = "error",timeout = 8000,layout = "centerRight"})
			end
		end
	end})
end)