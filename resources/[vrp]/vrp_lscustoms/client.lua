...
local lsc = {
	...
	,["primarymetallic"] = { 
		...
		["secondaryclassic"] = { 
			...
			name = "suspensions",
			buttons = { 
				{name = "Stock Suspension",mod = -1,modtype =15, costs = 250, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Lowered Suspension",mod = false,modtype =15, costs = 750, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Street Suspension",mod = 1,modtype =15, costs = 1250, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sport Suspension",mod = 2,modtype =15, costs = 1750, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Competition Suspension",mod = 3,modtype =15, costs = 2250, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["transmission"] = { 
			title = "transmissions", 
		...
		["turbo"] = { 
			...
			buttons = { 
				...
				{name = "Turbo Tuning",mod = true,modtype =18, costs = 2100, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["wheels"] = { 
			title = "wheels", 
		...
		name = "repair",
		buttons = { 
			{name = "Reparer køretøj", description = "", costs = 0, centre = 0, font = 0, scale = 0.4}
	...
	["brakes"] = { 
		...
		buttons = { 
			...
			{name = "Street Brakes",modtype = 12, mod = false, costs = 1100, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Sport Brakes",modtype = 12, mod = 1, costs = 1500, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Race Brakes",modtype = 12, mod = 2, costs = 1900, description = "", centre = 0, font = 0, scale = 0.4}
	...
	["engine"] = { 
		...
		name = "engine",
		buttons = { 
			{name = "EMS Upgrade, Level 1",modtype = 11, mod = -1, costs = 800, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 2",modtype = 11, mod = false, costs = 1600, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 3",modtype = 11, mod = 1, costs = 2400, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 4",modtype = 11, mod = 2, costs = 3200, description = "", centre = 0, font = 0, scale = 0.4}
		}
	},
	["horn"] = { 
			title = "horns", 
		...
		if DoesEntityExist(veh) then
			if damage < 995 or not AreAllVehicleWindowsIntact(veh) or IsVehicleDoorDamaged(veh,0) or IsVehicleDoorDamaged(veh,1) or IsVehicleDoorDamaged(veh,2) or IsVehicleDoorDamaged(veh,3) then
					if GetVehicleClass(veh) == 13 then
						...
						TriggerEvent("pNotify:SendNotification",{text = "Du skal betale <b style='color: #FFC832'>"..repairprice.." $</b> for at få dit køretøj repareret.",type = "info",timeout = (3000),layout = "centerRight",queue = "lsrepair0",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
					end
			else
