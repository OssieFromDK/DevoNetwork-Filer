...
AddEventHandler("scrap:SuccessNPC", function() -- NPC VEHICLE
	TriggerEvent("pNotify:SendNotification",{text = "Du har skrottet køretøjer for 1000 $",type = "success",timeout = (3500),layout = "centerRight",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
...
AddEventHandler("scrap:Success", function() -- PLAYER VEHICLE
	if vehPrice == nil then
		...
		TriggerEvent("pNotify:SendNotification",{text = "Du har skrottet kørerøjet og modtager "..modPrice.." $",type = "success",timeout = (3500),layout = "centerRight",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
