...
AddEventHandler('carwash:success', function()
	...
	TriggerEvent("pNotify:SendNotification", {text = "Betalte 145 $", type = "info", queue = "global", timeout = 5000, layout = "bottomCenter",animation = {open = "gta_effects_open", close = "gta_effects_close"}})
end)
