...
cfg.items = {
	-- farming
	["kniv"] = {"Køkken kniv", "En normal køkken kniv købt i bilka.", nil, 2.0}, -- no choices
	...
	["notesblok"] = {"Notesblok", "En notesblok", nil, 0.01}, -- no choices
	...
	["bank_Penge"] = {"Penge Fra Banken", "$.", nil, 0}, -- no choices
  ...
  -- Våben
	["wbody|WEAPON_VINTAGEPISTOL"] = {"Fartmåler", "", nil, 2.00},
	["wammo|WEAPON_VINTAGEPISTOL"] = {"Fartmåler ammo", "", nil, 2.00},
	["wbody|WEAPON_PISTOL"] = {"Håndpistol", "", nil, 2.01},
	["wammo|WEAPON_PISTOL"] = {"Håndpistol ammo", "", nil, 2.01},
	["wbody|WEAPON_PISTOL_MK2"] = {"Tjenestepistol", "", nil, 2.01},
	["wammo|WEAPON_PISTOL_MK2"] = {"Tjenestepistol ammo", "", nil, 2.01},
	["wbody|WEAPON_MARKSMANPISTOL"] = {"Marksmanpistol", "", nil, 2.01},
	["wammo|WEAPON_MARKSMANPISTOL"] = {"Marksmanpistol ammo", "", nil, 2.01},
	["wbody|WEAPON_SNSPISTOL"] = {"SNS Pistol", "", nil, 2.01},
	["wammo|WEAPON_SNSPISTOL"] = {"SNS Pistol ammo", "", nil, 2.01},
	["wbody|WEAPON_REVOLVER"] = {"Smith&Wesson", "", nil, 2.01},
	["wammo|WEAPON_REVOLVER"] = {"Smith&Wesson ammo", "", nil, 2.01},
	["wbody|WEAPON_HEAVYPISTOL"] = {"Heavypistol", "", nil, 2.01},
	["wammo|WEAPON_HEAVYPISTOL"] = {"Heavypistol ammo", "", nil, 2.01},
	["wbody|WEAPON_MACHINEPISTOL"] = {"Maskinpistol", "", nil, 2.01},
	["wammo|WEAPON_MACHINEPISTOL"] = {"Maskinpistol ammo", "", nil, 2.01},
	["wbody|WEAPON_PISTOL50"] = {".50 Desert Eagle", "", nil, 2.01},
	["wammo|WEAPON_PISTOL50"] = {".50 Desert Eagle ammo", "", nil, 2.01},
	["wbody|WEAPON_MOLOTOV"] = {"Molotov", "", nil, 2.01},
	["wammo|WEAPON_MOLOTOV"] = {"Molotov brændstof", "", nil, 2.01},
	["wbody|WEAPON_PUMPSHOTGUN"] = {"Pumpshotgun", "", nil, 2.01},
	["wammo|WEAPON_PUMPSHOTGUN"] = {"Pumpshotgun shells", "", nil, 2.01},
	["wbody|WEAPON_ASSAULTSHOTGUN"] = {"Kampshotgun", "", nil, 2.01},
	["wammo|WEAPON_ASSAULTSHOTGUN"] = {"Kampshotgun shells", "", nil, 2.01},
	["wbody|WEAPON_SAWNOFFSHOTGUN"] = {"Afskåret shotgun", "", nil, 2.01},
	["wammo|WEAPON_SAWNOFFSHOTGUN"] = {"Afskåret shotgun shells", "", nil, 2.01},
	["wbody|WEAPON_ASSAULTRIFLE"] = {"Kamprifle", "", nil, 2.01},
	["wammo|WEAPON_ASSAULTRIFLE"] = {"Kamprifle ammo", "", nil, 2.01},
	["wbody|WEAPON_CARBINERIFLE"] = {"Karbinriffel", "", nil, 2.01},
	["wammo|WEAPON_CARBINERIFLE"] = {"Karbinriffel ammo", "", nil, 2.01},
	["wbody|WEAPON_HEAVYSNIPER"] = {"Snigskytte riffel", "", nil, 2.01},
	["wammo|WEAPON_HEAVYSNIPER"] = {"Snigskytte riffel ammo", "", nil, 2.01},
	["wbody|WEAPON_SNIPERRIFLE"] = {"Jagtriffel", "", nil, 2.01},
	["wammo|WEAPON_SNIPERRIFLE"] = {"Jagtriffel ammo", "", nil, 2.01},
	["wbody|WEAPON_GUSENBERG"] = {"Tommygun", "", nil, 2.01},
	["wammo|WEAPON_GUSENBERG"] = {"Tommygun drum-mag", "", nil, 2.01},
	["wbody|WEAPON_STUNGUN"] = {"Strømpistol", "", nil, 2.01},
	["wbody|WEAPON_COMBATPISTOL"] = {"Combatpistol", "", nil, 2.01},
	["wammo|WEAPON_COMBATPISTOL"] = {"Combatpistol ammo", "", nil, 2.01},
	["wbody|WEAPON_COMBATPDW"] = {"Kamp PDW", "", nil, 2.01},
	["wammo|WEAPON_COMBATPDW"] = {"Kamp PDW ammo", "", nil, 2.01},
	["wbody|WEAPON_CARBINERIFLE_MK2"] = {"Karbinriffel Mk2", "", nil, 2.01},
	["wammo|WEAPON_CARBINERIFLE_MK2"] = {"Karbinriffel Mk2 ammo", "", nil, 2.01},
	["wbody|WEAPON_HEAVYSNIPER_MK2"] = {"Barrett M82 .50cal", "", nil, 2.01},
	["wammo|WEAPON_HEAVYSNIPER_MK2"] = {"Barrett M82 .50cal ammo", "", nil, 2.01},
	["wbody|WEAPON_SMG"] = {"SMG", "", nil, 2.01},
	["wammo|WEAPON_SMG"] = {"SMG ammo", "", nil, 2.01},
	["wbody|WEAPON_MINISMG"] = {"MiniSMG", "", nil, 2.01},
	["wammo|WEAPON_MINISMG"] = {"MiniSMG ammo", "", nil, 2.01},
	["wbody|WEAPON_MICROSMG"] = {"MicroSMG", "", nil, 2.01},
	["wammo|WEAPON_MICROSMG"] = {"MicroSMG ammo", "", nil, 2.01},
	["wbody|WEAPON_BATTLEAXE"] = {"Kampøkse", "", nil, 2.01},
	["wbody|WEAPON_BALL"] = {"Baseballbold", "", nil, 2.01},
	["wbody|WEAPON_GOLFCLUB"] = {"Golfkølle", "", nil, 2.01},
	["wbody|WEAPON_KNIFE"] = {"Kniv", "", nil, 2.01},
	["wbody|WEAPON_BAT"] = {"Baseball bat", "", nil, 2.01},
	["wbody|WEAPON_POOLCUE"] = {"Poolkø", "", nil, 2.01},
	["wbody|WEAPON_MACHETE"] = {"Machete", "", nil, 2.01},
	["wbody|WEAPON_CROWBAR"] = {"Brækjern", "", nil, 2.01},
	["wbody|WEAPON_SWITCHBLADE"] = {"Foldekniv", "", nil, 2.01},
	["wbody|WEAPON_KNUCKLE"] = {"Knojern", "", nil, 2.01},
	["wbody|WEAPON_WRENCH"] = {"Svensknøgle", "", nil, 2.01},
	["wbody|WEAPON_HAMMER"] = {"Hammer", "", nil, 2.01},
	
	---- STRIPS/POSER ---------
	["strips"] = {"Strips", "", nil, 0.5},
	["pose"] = {"Pose", "", nil, 0.5},
	
	---- Items ----
	["paraply"] = {"Paraply", "", nil, 3.00},
	["unicorn"] = {"Unicorn", "", nil, 3.00},
	["stok"] = {"Stok", "", nil, 1.00},
	["kuffert"] = {"Kuffert", "", nil, 5.00},
	["box"] = {"Box", "", nil, 2.00},
