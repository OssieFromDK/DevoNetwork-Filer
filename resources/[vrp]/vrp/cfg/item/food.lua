...
items["water"] = {"Vand flaske","", gen("drink",0,-25,0),0.5}
items["milk"] = {"Mælk","", gen("drink",0,-10,0),0.5}
items["coffee"] = {"Kaffe","", gen("drink",0,-10,0),0.5}
items["tea"] = {"Te","", gen("drink",0,-15,0),0.5}
items["icetea"] = {"Is Te","", gen("drink",0,-20,0), 0.5}
items["orangejuice"] = {"Appelsin juice","", gen("drink",0,-25,0),0.5}
items["gocagola"] = {"Læskedrik","", gen("drink",0,-35,0),0.5}
items["redgull"] = {"Redbull","", gen("drink",0,-40,0),0.5}
items["sure"] = {"Små Sure","", gen("drink",15,-10,0.25),0.5}
items["vodka"] = {"Vodka","", gen("drink",15,-10,0.25),0.5}
items["sodavand"] = {"Stor Sodavand","", gen("drink",0,-25,0),0.5}
items["romogcola"] = {"Rom og Cola","", gen("drink",0,-5,0.25),0.5}
items["ginogtonic"] = {"Gin og Tonic","", gen("drink",0,-5,0.25),0.5}
items["tequilla"] = {"Tequilla Sunrise","", gen("drink",0,-5,0.25),0.5}
items["sexbeach"] = {"Sex on the beach","", gen("drink",0,-5,0.25),0.5}
items["whisky"] = {"Whisky","", gen("drink",0,-5,0.25),0.5}
items["gin"] = {"Gin","", gen("drink",0,-5,0.25),0.5}
items["vodkajuice"] = {"Vodka Juice","", gen("drink",0,-5,0.25),0.5}
items["kinder"] = {"Kinderæg Shot","", gen("drink",-10,0,0.25),0.5}

--FOOD

-- create Breed item
items["kinderegg"] = {"Kinderæg","", gen("eat",-10,0,0),0.5}
items["bread"] = {"Brød","", gen("eat",-10,0,0),0.5}
items["pizza"] = {"Pizza","", gen("eat",-10,0,0),0.5}
items["donut"] = {"Donut","", gen("eat",-15,0,0),0.5}
items["tacos"] = {"Tacos","", gen("eat",-20,0,0),0.5}
items["sandwich"] = {"Sandwich","A tasty snack.", gen("eat",-25,0,0),0.5}
items["kebab"] = {"Kebab","", gen("eat",-45,0,0),0.5}
items["pdonut"] = {"Chokolade donut","", gen("eat",-25,0,0),0.5}
