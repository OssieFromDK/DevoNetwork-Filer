...
cfg.groups = {
  ...
  ["Refund"] = {
    _config = {
		onjoin = function(player) 
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Refund rank tildelt.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
		end,
		onleave = function(player) 
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Refund rank frataget.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
		end,
		onspawn = function(player) end
    },
	"player.givemoney",
  ...
  ["Politi-Job"] = {
    ...
    _config = { 
		...
		onjoin = function(player)
			...
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Chief of Police.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
    ...
    ["Assistent Chief of Police"] = {
    _config = { 
		gtype = "Politi-Job",
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Assistent Chief of Police.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}, WEAPON_SMG = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
    ...
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Police Captain.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}, WEAPON_SMG = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
    ...
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Police Lieutenant.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}, WEAPON_SMG = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
    ...
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Staff Seargent.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}, WEAPON_SMG = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
  ...
  ["SWAT"] = {
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu SWAT.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}, WEAPON_SMG = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
    ...
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu NOOSE.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}, WEAPON_SMG = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
  ...
  ["FIB"] = {
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu FIB.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
...
"police.menu",
  ...
  ["Civillian Officer"] = {
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Civillian Officer.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
...
"police.menu",
  ...
  ["Seargent"] = {
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Seargent.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
...
"police.menu",
  ...
  ["Police Officer"] = {
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Police Officer.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
...
"police.menu",
  ...
  ["Sheriff"] = {
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Sheriff.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
...
"police.menu",
  ...
  ["Officer"] = {
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Officer.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
...
"police.menu",
  ...
  ["Police Trainee"] = {
    _config = { 
		...
		onjoin = function(player)
			vRPclient.setCop(player,{true})
			TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Police Trainee.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			vRPclient.giveWeapons(player,{{WEAPON_NIGHTSTICK = {ammo = 1}, WEAPON_FLASHLIGHT = {ammo = 1}, WEAPON_STUNGUN = {ammo = 1}, WEAPON_COMBATPISTOL = {ammo = 250}}})
		end,
		onspawn = function(player)
			vRPclient.setCop(player,{true})
...
"police.menu",
	...
	["Chief of EMT"] = {
		_config = {
			...
			onjoin = function(player)
				vRPclient.setCop(player,{true})
				TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Chief of EMT.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			end,
			onspawn = function(player)
				vRPclient.setCop(player,{true})
			end,
	...
	["Assistent Chief of EMT"] = {
		_config = {
			gtype = "EMS-Job",
			onjoin = function(player)
				vRPclient.setCop(player,{true})
				TriggerClientEvent("pNotify:SendNotification", player,{text = "Du er nu Assistent Chief of EMT.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
			end,
			onspawn = function(player)
				vRPclient.setCop(player,{true})
			end,
