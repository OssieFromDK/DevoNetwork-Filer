                                                        ...
                                                        vRP.request(target,"<b>"..fornavnP.." "..efternavnP.."</b> ønsker at sælge sin <b>"..name.."</b> til en pris på <b style='color: #96D3FF'>"..amount.." $</b>", 10, function(target,ok)
                                                            if ok then
                                                                ...
                                                                if vRP.tryFullPayment(pID, amount) then
                                                                    ...
                                                                    PerformHttpRequest('https://discordapp.com/api/webhooks/640568252610904113/-474dzmk5R5w-n89InyTyXQgoE0o95uNEgz9WdekvGZiMlSTYIu_rHpvLzp_152RLZBY', function(err, text, headers) end, 'POST', json.encode({username = "Salg af køretøj - Server " .. GetConvar("servernumber","0"), content = "**"..fornavnP.." "..efternavnP.." ("..p_id..")** solgte sit køretøj **"..name.."** til **"..fornavnT.." "..efternavnT.." ("..t_id..")** for **"..amount.." $**."}), { ['Content-Type'] = 'application/json' })
                                                                else
