...
AddEventHandler('delivery:success1', function(amount)
    ...
    TriggerClientEvent("pNotify:SendNotification", source,{text = "<h3>💰Modtog <b style='color: #4E9350'>"..amount.." $</b>.", type = "success", queue = "global", timeout = 5000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
end)