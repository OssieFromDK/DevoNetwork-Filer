...
AddEventHandler("chatMessage", function(s, n, m)
  ...
  if command[1] == "/balance" then
    TriggerClientEvent("pNotify:SendNotification", source,{text = "Du har "..bankbalance..",- $", type = "success", queue = "global", timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
    TriggerClientEvent("banking:updateBalance", source, bankbalance, wallet)
    CancelEvent()
  end
  ...
  if not amount then return end
    ...
    if(string.len(rounded) >= 9) then
      ...
      if(rounded <= wallet) then
        ...
        TriggerClientEvent("pNotify:SendNotification", source,{text = "Du indsatte <b style='color: #4E9350'>"..math.floor(rounded).." $</b>.", type = "success", queue = "global", timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
  ...
  if not amount then return end
    ...
    if(string.len(rounded) >= 9) then
      ...
      if(tonumber(rounded) <= tonumber(bankbalance)) then
        ...
        TriggerClientEvent("pNotify:SendNotification", source,{text = "Du hævede <b style='color: #4E9350'>"..math.floor(rounded).." $</b>.", type = "success", queue = "global", timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
  ...
  if tonumber(fPlayer) == tonumber(toPlayer) then
    ...
    if(string.len(rounded) >= 9) then
      ...
      if(tonumber(rounded) <= tonumber(bankbalance)) then
		...
		TriggerClientEvent("pNotify:SendNotification", fPlayer,{text = "Overførte: <b style='color: #DB4646'>"..math.floor(rounded).." $</b>.", type = "success", queue = "global", timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
        TriggerClientEvent("pNotify:SendNotification", fPlayer,{text = "Ny saldo: <b style='color: #FFC832'>"..math.floor((bankbalance - rounded)).." $</b>.", type = "info", queue = "global", timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
		...
		TriggerClientEvent("pNotify:SendNotification", toPlayer,{text = "Modtog: <b style='color: #4E9350'>"..math.floor(rounded).." $</b>.", type = "success", queue = "global", timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
        TriggerClientEvent("pNotify:SendNotification", toPlayer,{text = "Ny saldo: <b style='color: #FFC832'>"..math.floor((bankbalance2 - rounded)).." $</b>.", type = "info", queue = "global", timeout = 4000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
