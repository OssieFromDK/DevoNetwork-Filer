...
function transfer(fPlayer, tPlayer, amount)
    ...
    TriggerClientEvent("pNotify:SendNotification", source,{text = "Du overførte <b style='color: #4E9350'>"..math.floor(amount).." $</b>", type = "success", queue = "global", timeout = 5000, layout = "bottomCenter",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
    TriggerClientEvent("pNotify:SendNotification", source,{text = "Nyt indestående beløb: <b style='color: #4E9350'>"..math.floor((new_balance)).." $</b>", type = "info", queue = "global", timeout = 5000, layout = "bottomCenter",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
    ...
    TriggerClientEvent("pNotify:SendNotification", source2,{text = "Du modtog <b style='color: #4E9350'>"..math.floor((amount))" $</b>", type = "success", queue = "global", timeout = 5000, layout = "bottomCenter",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
    TriggerClientEvent("pNotify:SendNotification", source2,{text = "Nyt indestående beløb: <b style='color: #4E9350'>"..math.floor((new_balance2))" $</b>", type = "success", queue = "global", timeout = 5000, layout = "bottomCenter",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
...
AddEventHandler('bank:depositAll', function()
    ...
    if(wallet > 0) then
        ...
        TriggerClientEvent("pNotify:SendNotification", source, {
            text = "Du indsatte <b style='color: #4E9350'>"..format_thousand(math.floor(rounded)).." $</b>.",
            type = "success",
            timeout = (4000),
            layout = "bottomCenter",
            queue = "global",
...
AddEventHandler('bank:withdraw', function(amount)
    ...
    if(tonumber(rounded) <= tonumber(bankbalance)) then
        ...
        TriggerClientEvent("pNotify:SendNotification", source, {
            text = "Du hævede <b style='color: #4E9350'>"..format_thousand(math.floor(rounded)).." $</b>.",
            type = "success",
            timeout = (4000),
            layout = "bottomCenter",
            queue = "global",
