...
local directions = { [0] = 'N', [1] = 'NV', [2] = 'V', [3] = 'SV', [4] = 'S', [5] = 'SØ', [6] = 'Ø', [7] = 'NØ', [8] = 'N' } 
    ...
    while true do
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            if pedInVeh and GetIsVehicleEngineRunning(vehicle) and vehicleClass ~= 13 then
                ...
                drawTxt("Fartpilot", 2, cruiseColor, 0.4, screenPosX + 0.027, screenPosY + 0.048)

                -- Draw seatbelt status if not a motorcyle
                if vehicleClass ~= 8 then
                    local seatbeltColor = seatbeltIsOn and seatbeltColorOn or seatbeltColorOff
                    drawTxt("Sele", 2, seatbeltColor, 0.4, screenPosX + 0.074, screenPosY + 0.048) -- GET_VEHICLE_NUMBER_PLATE_TEXT(vehicle);
                end
            end
        end
    end
...
Citizen.CreateThread(function()
    while true do
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            timeText = ("%.2d"):format((hour == 0) and 12 or hour) .. ":" .. ("%.2d"):format( minute) .. ((hour < 12) and " " or " ")
            ...
            if pedInVeh then
                ...
                if fuelShowPercentage then
                    ...
                    currentFuel = 0.0 * GetVehicleFuelLevel(vehicle) / GetVehicleHandlingFloat(vehicle,"CHandlingData","fPetrolTankVolume")
                else
