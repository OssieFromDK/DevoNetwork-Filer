	...
	while true do
		...
		for i=1, #Config.RealWeapons, 1 do
    		...
    		if HasPedGotWeapon(playerPed, weaponHash, false) then
                ...
                GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_CARBINERIFLE_MK2"), GetHashKey("COMPONENT_AT_AR_FLSH"))
                GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_CARBINERIFLE_MK2"), GetHashKey("COMPONENT_AT_PI_FLSH_02"))
                ...
                --Tjenestepistol
				GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_PISTOL_MK2"), GetHashKey("COMPONENT_AT_PI_FLSH_02"))
				GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_PISTOL_MK2"), GetHashKey("COMPONENT_PISTOL_MK2_CLIP_01"))
				GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_PISTOL_MK2"), GetHashKey("COMPONENT_AT_PI_COMP"))
				GiveWeaponComponentToPed(playerPed, GetHashKey("WEAPON_PISTOL_MK2"), GetHashKey("COMPONENT_PISTOL_MK2_CAMO"))
