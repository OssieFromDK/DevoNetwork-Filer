...
AddEventHandler('chatMessage', function(source, name, msg)
    ...
    elseif string.lower(args[1]) == "/say" then
        CancelEvent()
    elseif string.lower(args[1]) == "7emotee" then
        CancelEvent()
    elseif string.lower(args[1]) == "/mee" then
        CancelEvent()
    elseif string.lower(args[1]) == "7briller" then
        CancelEvent()
    elseif string.lower(args[1]) == "/brille" then
        CancelEvent()
    elseif string.lower(args[1]) == "7hat" then
        CancelEvent()
    elseif string.lower(args[1]) == "/har" then
        CancelEvent()
    elseif string.lower(args[1]) == "7har" then
        CancelEvent()
    elseif string.lower(args[1]) == "/bukserr" then
        CancelEvent()
    elseif string.lower(args[1]) == "7bukser" then
        CancelEvent()
    elseif string.lower(args[1]) == "/trojer" then
        CancelEvent()
    elseif string.lower(args[1]) == "7trøjer" then
        CancelEvent()
    elseif string.lower(args[1]) == "/maskee" then
        CancelEvent()
    elseif string.lower(args[1]) == "7maske" then
        CancelEvent()
    elseif string.lower(args[1]) == "/mask" then
        CancelEvent()
    elseif string.lower(args[1]) == "7ooc" then
        CancelEvent()
    elseif string.lower(args[1]) == "/ooc" then
        CancelEvent()
    elseif string.lower(args[1]) == "7twt" then
        CancelEvent()
    elseif string.lower(args[1]) == "/twt" then
        CancelEvent()
    elseif string.lower(args[1]) == "fuck" then
        CancelEvent()
    elseif string.lower(args[1]) == "/hej" then
        CancelEvent()
    elseif string.lower(args[1]) == "7emote" then
        CancelEvent()
    elseif string.lower(args[1]) == "/tagtrøjeraf" then
        CancelEvent()
    elseif string.lower(args[1]) == "/tagtrøjeaf" then
        CancelEvent()
    ...
    elseif string.lower(args[1]) == "/ansigter" or string.lower(args[1]) == "/faces" then
        TriggerClientEvent("cn-animation:showFaces", source)
        CancelEvent()
    elseif msg == "/paraply" or msg == "/unicorn" or msg == "/pizza" or msg == "/stok" or msg == "/kuffert" or msg == "/bor" or msg == "/box" or msg == "/mobil" or msg == "/ringer" or msg == "/notesblok" then
        ...
        elseif msg == "/notesblok" then
            animWithItem(user_id,{"notesblok"},"en notesblok", "notesblok", source)
