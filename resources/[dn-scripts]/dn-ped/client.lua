local peds = {
    ...
    {ishash=true, model= 0xe497bbef, dict="mini@strip_club@idles@bouncer@base", anim="base", voice="S_M_M_HAIRDRESSER_01_BLACK_MINI_01", coords={1100.9234619141,-3100.1442871094,-39.999950408936,90.0}},
    {model= "a_m_m_og_boss_01", dict="mini@strip_club@idles@bouncer@base", anim="base", voice="S_M_M_HAIRDRESSER_01_BLACK_MINI_01", coords={-1623.048828125,-994.83270263672,6.6255173683167,320.0}}, 
    {ishash=true, model= 0xe497bbef, dict="mini@strip_club@idles@bouncer@base", anim="base", voice="S_M_M_HAIRDRESSER_01_BLACK_MINI_01", coords={224.73059082031,-1982.0826416016,18.752714157104,253.0}},
    {model= "a_m_m_og_boss_01", dict="mini@strip_club@idles@bouncer@base", anim="base", voice="S_M_M_HAIRDRESSER_01_BLACK_MINI_01", coords={-1564.9459228516,-3235.6572265625,25.336153030396,250.0}}, 
    {ishash=true, model= 0xe497bbef, dict="mini@strip_club@idles@bouncer@base", anim="base", voice="S_M_M_HAIRDRESSER_01_BLACK_MINI_01", coords={-2036.8909912109,-1033.7723388672,4.8823900222778,250.0}}, -- -1868718465
    {model= "a_m_m_og_boss_01", dict="mini@strip_club@idles@bouncer@base", anim="base", voice="S_M_M_HAIRDRESSER_01_BLACK_MINI_01", coords={1296.9165039063,1452.3369140625,98.469497680664,360.0}}, 

    -- Bilforhandler
    {ishash=true, model= 1868718465, dict="amb@prop_human_seat_chair@male@generic@base", anim="base", voice="S_M_M_HAIRDRESSER_01_BLACK_MINI_01", coords={-55.991203308105,-1098.4608154297,26.886358261108,360.0}}, -- -1868718465
}
...
Citizen.CreateThread(function()
  ...
  SetPedComponentVariation(ped, 11, 149, 0, 2) -- dykkerdragt top på mand
  SetPedComponentVariation(ped, 8, 15, 0, 2) -- dykkertank mand
  SetPedComponentVariation(ped, 6, 24, 0, 2) -- dykkermaske mand
  SetPedComponentVariation(ped, 4, 35, 0, 2) -- dykkerdragt bund på mand
  ...
  SetPedComponentVariation(ped, 3, 0, 0, 2) -- Hår
end)
