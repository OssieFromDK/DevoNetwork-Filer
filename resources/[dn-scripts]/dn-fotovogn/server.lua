...
AddEventHandler('cn-fotovogn:betal', function(speed,limit,veh)
	...
	if payment ~= false then
		if payment == "paid" then
			TriggerClientEvent("pNotify:SendNotification", source,{text = "<b style='color:#ED2939'>Fotovogn</b><br /><br />Du kørte " .. speed .. "km/t hvor du må køre "..limit.." km/t <br /><b style='color:#26ff26'>Bøde</b>: " .. tax .." $", type = "error", queue = "fart", timeout = 8000, layout = "centerRight",animation = {open = "gta_effects_open", close = "gta_effects_close"}})
		else
			TriggerClientEvent("pNotify:SendNotification", source,{text = "<b style='color:#ED2939'>Fotovogn</b><br /><br />Du kørte " .. speed .. "km/t hvor du må køre "..limit.." km/t <br /><b style='color:#26ff26'>Bøde</b>: " .. tax .." $".."<br>Nuværende gæld: <b style='color: #DB4646'>"..format_thousands(payment).." $</b>", type = "error", queue = "fart", timeout = 8000, layout = "centerRight",animation = {open = "gta_effects_open", close = "gta_effects_close"}})
		end
    end
